...
def main():
    """메인 함수"""
    st.set_page_config(
        page_title="상명대 학사안내 AI 에이전트",
        page_icon="🎓",
        layout="wide"
    )

    st.title("🎓 상명대 2026-2학기 학사안내 AI 에이전트 워크플로")
    st.markdown("---")
    ...
    with st.sidebar:
        ...
        **벡터 검색 (2026-2학기 학사안내 문서):**
        - "2026학년도 2학기 수강신청 기간은 언제인가요?"
        - "성적 정정 및 이의신청 기간을 알려주세요"
        - "휴학·복학 신청 방법과 기간이 어떻게 되나요?"
        - "2학기 등록금 납부 기간은 언제까지인가요?"
        """)
