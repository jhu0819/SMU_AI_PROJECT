...
<table_descriptions>
- art: 2급 문화예술교육사 인정 학과(전공) 정보 (id, 분야 [디자인/공예/사진/영화/연극/만화·애니메이션], 단과대학, "학과(전공)")
- art_2: 2급 문화예술교육사 취득을 위한 분야별 인정 교육과정 정보 (id, 분야, "신청 교과목명", 학점, 개설학년, 인정시기, 비고)
</table_descriptions>
...
- art와 art_2는 id로 연결되지 않습니다. 두 테이블을 JOIN할 때는 반드시 분야 컬럼(art.분야 = art_2.분야)을 기준으로 연결하세요
- 공백이나 괄호가 포함된 컬럼명("학과(전공)", "신청 교과목명")은 반드시 큰따옴표로 감싸세요
- 세미콜론(;)으로 쿼리를 종료하세요
</rules>
"""
